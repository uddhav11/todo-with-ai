    ...
    <form onSubmit={handleSubmit} className="text-white">
      <div className="mb-4">
        ...
        <input
          ...
          value={formData.title}
          onChange={handleChange}
          className="w-full p-2 border rounded-lg border-purple-500 bg-gray-700 focus:border-purple-400 focus:outline-none"
          required
        />
      </div>
      <div className="mb-4">
      ...
      <div className="mb-4">
        ...
        <DatePicker
          selected={formData.deadline}
          onChange={handleDateChange}
          className="w-full p-2 border rounded-lg text-center border-purple-500 bg-gray-700 focus:border-purple-400 focus:outline-none"
          minDate={new Date()}
          required
        />
      </div>
      <div className="mb-4">
        <label className="block text-purple-300 mb-2">Priority</label>
        <select
          name="priority"
          value={formData.priority}
          onChange={handleChange}
